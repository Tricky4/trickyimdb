...
class StreamPlatformTestCase(APITestCase):
    ...
    def test_streamplatform_ind(self):
        response = self.client.get(reverse('streamlist-detail', args=(self.stream.id,)))
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_streamplatform_destroy(self):
        response = self.client.delete(reverse('streamlist-detail', args=(self.stream.id,)))
        self.assertEqual(response.status_code, status.HTTP_403_FORBIDDEN)
...
class WatchListTestCase(APITestCase):
    ...
    def test_watchlist_update(self):
        ...
        response = self.client.put(reverse('watch-list'), data)
        self.assertEqual(response.status_code, status.HTTP_403_FORBIDDEN)
        
    def test_watchlist_destroy(self):
